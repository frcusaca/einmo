...
# EIMP-31: Extra-repository verification and assurance
...
[the contract catalogue](EIMP-31.contract.assurance_validation.md).
...
[the human-responsibility design supplement](EIMP-31.design.human_responsibility.md).
...
workflows. See [the structured-test design supplement](EIMP-31.design.structured_tests.md).
...
[the Week 2 user story](EIMP-31.user_story.week_2_expand_coverage.md).
...
|---|---|
| [Day 1](EIMP-31.user_story.day_1_first_baseline.md) | How is the first independently protected baseline established? |
| [Day 2](EIMP-31.user_story.day_2_regression_and_failure.md) | What happens on an ordinary pass, a regression, and a retry? |
| [Week 2](EIMP-31.user_story.week_2_expand_coverage.md) | How are old obligations checked before coverage expands for new code? |
| [Removed commit and patched tests](EIMP-31.user_story.detected_many_broken_cases.md) | How does independent validation focus human attention when subject-owned tests were made green? |
| [Ignored suite](EIMP-31.user_story.detected_ignored_suite.md) | Who detects an ignored inner case, outer suite wrapper, or entire validation job? |
| [Sequential failure cascade](EIMP-31.user_story.sequential_failure_cascade.md) | How do hierarchy and sequence turn many red leaves into truthful causal context? |
| [Unavailable or stale inventory](EIMP-31.user_story.inventory_unavailable_or_stale.md) | When may an authenticated local inventory be used offline, and how is rollback refused? |
| [Inputs mutate during execution](EIMP-31.user_story.checkout_mutated_during_run.md) | Why are clean pre/post checks insufficient, and which paths may remain writable? |
| [Store a successful result](EIMP-31.user_story.store_success_without_changing_verifier.md) | How can good evidence be appended without recursively changing the verifier identity it names? |
| [Intentional behavior change](EIMP-31.user_story.intentional_behavior_change.md) | How does a legitimate new requirement replace old expectations without rewriting history or bypassing staged review? |
| [Year 2](EIMP-31.user_story.year_2_evidence_evolution.md) | How do old evidence, new policy, key changes, platforms, and archives coexist? |

[The contract-to-story matrix](EIMP-31.traceability.contract_story_matrix.md)
...
The future `EIMP-31.plan.md` MUST follow `eimp.md`'s test-first and
sub-section-test-subset rules, including a final EIMP 31 comprehensive test.
...
- [Contract catalogue](EIMP-31.contract.assurance_validation.md)
- [Human understanding and responsible action](EIMP-31.design.human_responsibility.md)
- [Structured tests](EIMP-31.design.structured_tests.md)
- [Contract-to-story traceability](EIMP-31.traceability.contract_story_matrix.md)
- [Motivation, failure catalogue, and prior-art research](EIMP-31.research.motivation_and_prior_art.md)
