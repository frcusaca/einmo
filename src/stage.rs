...
/// One of the three promotion stages. Each maps to a directory that mirrors
/// the `input/` tree.
...
impl Stage {
    /// All three stages, in lifecycle order.
    pub const ALL: [Stage; 3] = [Stage::Output, Stage::Checked, Stage::Verified];
